  ...
  },
  {
    ...
    cell: ({ row }) => {
      return h('div', { class: 'flex items-center gap-3' }, [
        h('div', {
          class: 'w-12 h-12 rounded-lg bg-gray-100 flex-shrink-0 flex items-center justify-center'
        }, [
          h('i', {
            class: row.original.icon || 'i-lucide-folder',
            style: 'font-size: 20px; color: #6b7280;'
          })
        ]),
        h('div', undefined, [
