  ...
  try {
    const payload = {
      ...
      Address: {
        ...
        AddressLine2: null,
        City: form.value.province || null,
        StateOrProvinceId: selectedProvince.value?.id || null,
        DistrictId: null,
        WardId: selectedWard.value?.id || null,
        ContactName: form.value.fullName.trim(),
        PhoneNumber: form.value.phone || null,
        CountryId: 'VN'
      }
    }
      ...
      <div class="w-full max-w-screen-xl mx-auto px-6 py-6">
        <div class="flex flex-col lg:flex-row gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div class="md:col-span-2">
                    ...
                    <input v-model="form.fullName" type="text"
                      ...
                      placeholder="Nhập tên khách hàng" @blur="touchedName = true">
                  ...
                  <div>
                    ...
                    <input v-model="form.code" type="text" placeholder="VD: C0001"
                      class="w-full h-9 px-3 rounded-md border border-gray-300 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">
                  </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <RemoteSearchSelect v-model="selectedProvince" :fetch-fn="fetchProvinces"
                      ...
                      :dropdown-max-height="320" :full-width="true" search-in-trigger @select="onSelectProvince"
                  ...
                  <div>
                    ...
                    <input v-model="form.address" type="text" placeholder="Nhập địa chỉ cụ thể"
                      class="w-full h-9 px-3 rounded-md border border-gray-300 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">
                  </div>
                </div>
              </div>
          ...
          <div class="w-full lg:w-80 flex flex-col gap-6 flex-shrink-0">
            ...
            <UPageCard variant="soft" class="bg-white rounded-lg">
              ...
              <div class="-mx-6 px-6">
                <input v-model="form.tagsInput" type="text"
                  class="w-full h-9 px-3 rounded-md border border-gray-300 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                  placeholder="Tìm kiếm hoặc thêm mới tag" @keydown.enter.prevent="addTagFromInput">
                <div v-if="form.tags.length" class="flex flex-wrap gap-2 mt-3">
                  <div v-for="(t, i) in form.tags" :key="t + i"
        ...
        <div class="flex justify-end mt-8 mb-4">
          <button type="button"
            ...
            :disabled="!isValid || submitting" @click="onSubmit">
