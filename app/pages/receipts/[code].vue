          ...
          <div class="flex items-center gap-3 flex-shrink-0">
            ...
            <div class="flex flex-col">
              ...
              <div class="text-xs text-gray-500 mt-0.5">
                {{ formatDateTime(detail.createdOn) }}
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div v-if="evidenceFiles.length" class="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 text-left">
                  ...
                  >
                    ...
                    <button type="button" class="absolute top-1 right-1 bg-white/90 rounded-full p-1 shadow hover:bg-white" @click="removeFile(idx)">
